 ...
 * Bundled locally so the admin works fully offline as a PWA — no icon CDN.
 * Usage: icon('cart'[, 'ic']) → returns an <svg> string. */
(function (global) {
  'use strict';
  ...
  function icon(name, cls) {
    ...
    return '<svg class="ic ' + (cls || '') + '" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" ' +
